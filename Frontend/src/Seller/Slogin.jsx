...
const Slogin = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="relative max-w-md w-full bg-white bg-opacity-90 p-8 rounded-md shadow-md overflow-hidden">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-extrabold text-gray-900">Login to Seller account</h2>
          </div>
