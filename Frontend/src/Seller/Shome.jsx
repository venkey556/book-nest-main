...
function Shome() {
  ...
  const colors = ['#2B124C', '#AE4451', '#F39F5A','pink'];
  ...
  return (
     <div style={{ backgroundColor: "SkyBlue" }}>{/* Apply background color here */}
 
        <Snavbar/>
        <br/>
      <h3 className="text-3xl font-semibold mb-4 text-center" >DashBoard</h3>
      <Card body style={{ backgroundColor: "Aqua", width: "80%", marginLeft: "10%", marginTop: "20px", height: "580px" }}>
